...
public class TriggerKillEntity extends SelectableTrigger {// TODO trigger kill entity

	public TriggerKillEntity(String id, ItemStack stack, BiFunction<Customization, ContextHolder, List<ConfigElement>> relatedElements) {
