...
public class TriggerPlayerLogin extends SelectableTrigger {

	public TriggerPlayerLogin(String id, ItemStack stack, BiFunction<Customization, ContextHolder, List<ConfigElement>> relatedElements) {
