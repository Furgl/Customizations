...
public class KillEntityTrigger extends SelectableTrigger {// TODO trigger kill entity

	public KillEntityTrigger(String id, ItemStack stack, BiFunction<Customization, ConfigContextHolder, List<ConfigElement>> relatedElements) {
